...
<div class="row ">
    ...
    <p class=" medio m-0 p-0"   >  y el potencial para </p> <p class="naranja medio "> responder</p><p class="medio">  a los</p> <p class="naranja medio "> problemas sociales</p> <p class="medio">  mas urgentes</p>
</div>
...
<div class="row pl-3 pt-2 mt-3"  >

  <div class="col-sm-12 subM" style="padding-left:18px;">

    <h2 class=" d-none   d-md-block  d-lg-block  d-xl-block  ">IMPULSAMOS UNA</h2>
    <h4 class="  d-block  d-sm-block  d-md-none  d-lg-none  "style="margin-top:90px" >IMPULSAMOS UNA</h4 >

  </div>
  <div class="col-sm-12  subM" style="padding-left:18px;">


    <h2 class=" d-none   d-md-block   d-lg-block  d-xl-block ">SOCIEDAD DE AGENTES</h2>
    <h4 class="   d-block  d-sm-block  d-md-none  d-lg-none d-xl-none">SOCIEDAD DE AGENTES</h4>
  ...
  <div class="col-sm-12  subM" style="padding-left:18px;">
    ...
    <h2 class=" d-none   d-md-block   d-lg-block  d-xl-block ">DE CAMBIO</h2>
    <h4 class="   d-block  d-sm-block  d-md-none  d-lg-none d-xl-none">DE CAMBIO</h4>
